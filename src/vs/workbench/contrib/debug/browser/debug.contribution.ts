...
viewsRegistry.registerViews([{ id: DESYNT_VIEW_ID, name: nls.localize('desynt', "DeSynt"), containerIcon: icons.watchViewIcon, ctorDescriptor: new SyncDescriptor(DeSyntView), order: 20, weight: 10, canToggleVisibility: true, canMoveView: true, focusCommand: { id: 'workbench.debug.action.focusWatchView' }, when: CONTEXT_DEBUG_UX.isEqualTo('default') }], viewContainer);
