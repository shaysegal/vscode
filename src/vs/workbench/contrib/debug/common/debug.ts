...
export const DESYNT_HISTORY_VIEW_ID = 'workbench.debug.desyntHistoryView';
...
export const CONTEXT_DESYNT_CANDIDATE_EXIST = new RawContextKey<boolean>('desyntCandidateExist', false, { type: 'boolean', description: nls.localize('desyntCandidateExist', "True when there is candidate of synthesized program ") });
...
export const CONTEXT_DESYNT_HISTORY_SUPPORTED = new RawContextKey<boolean>('desyntHistorySupported', true, { type: 'boolean', description: nls.localize('desyntHistorySupported', "True when the focused sessions supports the DESYNT HISTORY view") });
export const CONTEXT_DESYNT_HISTORY_ITEM_TYPE = new RawContextKey<string>('loadedScriptsItemType', undefined, { type: 'string', description: nls.localize('desyntHistoryItemType', "Represents the item type of the focused element in the DESYNT HISTORY view.") });
...
export interface IDebugModel extends ITreeElement {
	...
	getWatchExpressions(desynt: Boolean): ReadonlyArray<IExpression & IEvaluate>;
